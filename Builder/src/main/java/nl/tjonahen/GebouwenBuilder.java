...
/**
 * Builder. Deze abstracte classe bepaald war er gebouwd kan worden. Hoe dit gebouwd word en of er iets gebouwd wordt is
 * afhankelijk van de concrete builder classe.
 *
 *
 *
 */
